...
export const ContactSection = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            toast({
                title: "Message sent!",
                description: "Thank you for your message. I'll get to you soon."
            })
        ...
        <section id="contact" className="py-24 px-4 relative bg-secondary/30">
            <div className="container mx-auto max-w-5xl">
                ...
                <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    ...
                    I'm always open to discussing new operation.
                </p>
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:ezesoham@gmail.com" target="_blank" className="text-muted-foreground hover:text-primary transition-colors">
                                        ezesoham@gmail.com
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+919330953567" className="text-muted-foreground hover:text-primary transition-colors">
                                        +91 9330 953 567
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
                        ...
                        <form className="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary" placeholder="johndoe@gmail.com"/>
                            </div>
                            <div>
